...
<head>
    ...
    <link rel="stylesheet" href="assest/css/jquery.Bootstrap-PersianDateTimePicker.css"/>

    <!-- Custom CSS -->
    <link rel="stylesheet" href="//cdn.rawgit.com/morteza/bootstrap-rtl/v3.3.4/dist/css/bootstrap-rtl.min.css">
    <!-- All Jquery -->

    <script src="assest/js/jquery-3.1.0.min.js" type="text/javascript"></script>
    ...
    <script src="assest/js/select2.full.js"></script>
    ...
    <script src="assest/js/kamadatepicker.js"></script>
            ...
            <div class="navbar-collapse">
                ...
                <ul class="navbar-nav mr-auto mt-md-0">
                    <span class="user_name">
                        كاربر
                        |
                        <? echo $action->admin()->name . " " . $action->admin()->lastname; ?>
                    </span>
                </ul>
                <!-- ----------- show name of user ----------------------------------------------------------------- -->
