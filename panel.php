            ...
            <div class="col-md-3">
                <a href="user-list.php">
                    <div class="card p-30 bg-success">
                        <div class="media">
                            <div class="media-left meida media-middle">
                                <span><i class="fa fa-users f-s-50 color-white"></i></span>
                            </div>
                            <div class="media-body media-text-right">
                    ...
                    <div class="card p-30 bg-danger">
                        <div class="media">
                            <div class="media-left meida media-middle">
                                ...
                                <span><i class="fa fa-house f-s-80 color-white"></i></span>
                            </div>
                            <div class="media-body media-text-right">
                                <span class="text-white f-s-30"><?= $action->table_cunter('tbl_property') ?></span>
                                <br>
                                <span class="text-white f-s-20">املاک</span>
                            </div>
                        </div>
                    </div>
                </a>
